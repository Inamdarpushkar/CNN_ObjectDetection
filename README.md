# Monitoring marine traffic: satellite imagery feature detection
...
This project has used openly licensed Planet satellite imagery collected over the San Francisco Bay area, and provided by a Kaggle user.
